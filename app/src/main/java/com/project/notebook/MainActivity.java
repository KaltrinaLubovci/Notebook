...
import com.project.notebook.adapters.NotesAdapter;
import com.project.notebook.callbacks.MainActionModeCallback;
import com.project.notebook.callbacks.NoteEventListener;
import com.project.notebook.db.NotesDB;
import com.project.notebook.db.NotesDao;
import com.project.notebook.model.Note;
import com.project.notebook.utils.NoteUtils;
...
import static com.project.notebook.EditNoteActivity.NOTE_EXTRA_Key;
...
public class MainActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
        ...
        SwitchDrawerItem switchDrawerItem = new SwitchDrawerItem()
                ...
                .withOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(IDrawerItem drawerItem, CompoundButton buttonView, boolean isChecked) {
                        // TODO: 01/07/2019 change to darck theme and save it to settings
                        if (isChecked) {
    ...
    public void onNoteClick(Note note) {
        // TODO: 01/07/2019  note clicked : edit note
    ...
    public void onNoteLongClick(Note note) {
        // TODO: 02/07/2019 note long clicked : delete , share ..
    ...
    private void onShareNote() {
        // TODO: 02/07/2019  we need share just one Note not multi

        Note note = adapter.getCheckedNotes().get(0);
        // TODO: 02/07/2019 do your logic here to share note ; on social or something else
    ...
    private void onDeleteMultiNotes() {
        // TODO: 02/07/2019 delete multi notes
    ...
    private ItemTouchHelper swipeToDeleteHelper = new ItemTouchHelper(
            new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
                ...
                public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                    // TODO: 03/07/2019 delete note when swipe
    ...
    private void swipeToDelete(final Note swipedNote, final RecyclerView.ViewHolder viewHolder) {
        new AlertDialog.Builder(MainActivity.this)
                ...
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        // TODO: 04/07/2019  Undo swipe and restore swipedNote
